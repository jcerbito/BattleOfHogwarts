...
public class MechanicsScreen extends DefaultScreen {
    Stage uiStage;
    ...
    void startUI(){
        ...
        helpOne = new Texture(Gdx.files.internal("help1.png"));
        ...
        TextButton homeBtn = new TextButton("HOME", buttonStyle);
    ...
    public MechanicsScreen(BattleOfHogwarts g){
        super(g);
