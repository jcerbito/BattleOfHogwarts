...
public class WinScreenAverage extends DefaultScreen {
    Stage uiStage;
    ...
    void startUI(){
        ...
        TextButton gameOverBtn = new TextButton("YOU WIN!", buttonStyle);
    ...
    public WinScreenAverage(BattleOfHogwarts g){
        super(g);
