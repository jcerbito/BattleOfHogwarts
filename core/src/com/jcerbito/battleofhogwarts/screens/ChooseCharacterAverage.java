...
public class ChooseCharacterAverage extends DefaultScreen {
    Stage uiStage;
    ...
    public static int charLockAve = 0;
    ...
    void startUI(){
        ...
        charButton.setPosition((uiStage.getWidth() / 3 - 60), uiStage.getHeight() / 2);
        charButtonTwo.setPosition((uiStage.getWidth() / 3 + 70), uiStage.getHeight() / 2);
        charButtonThree.setPosition((uiStage.getWidth() / 3 + 10), uiStage.getHeight() / 4);
        ...
        if ((GameUpgradeEasy.ulock + GameUpgradeAverage.ulock) <= 49){
    ...
    public ChooseCharacterAverage(BattleOfHogwarts g){
        super(g);
