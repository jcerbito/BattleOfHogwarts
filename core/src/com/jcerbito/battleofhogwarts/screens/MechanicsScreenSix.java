...
public class MechanicsScreenSix extends DefaultScreen {
    Stage uiStage;
    ...
    void startUI(){
        ...
        helpOne = new Texture(Gdx.files.internal("help6.png"));
        ...
        homeBtn.addListener(new ClickListener(){
            public void touchUp(InputEvent event, float x, float y, int pointer, int button){
                dispose();
                game.setScreen(new MechanicsScreenFive(game));
            }
        });

        TextButton nextBtn = new TextButton("HOME", buttonStyle);
    ...
    public MechanicsScreenSix(BattleOfHogwarts g){
        super(g);
