...
public class MechanicsScreenTwo extends DefaultScreen {
    Stage uiStage;
    ...
    void startUI(){
        ...
        helpOne = new Texture(Gdx.files.internal("help2.png"));
        Image hOne = new Image(helpOne);
        hOne.setPosition(0, uiStage.getHeight() / 5);

        helpTwo = new Texture(Gdx.files.internal("help2.png"));
        Image hTwo = new Image(helpTwo);
        hTwo.setPosition(0, uiStage.getHeight() / 5);
        ...
        nextBtn.addListener(new ClickListener(){
            public void touchUp(InputEvent event, float x, float y, int pointer, int button){
                dispose();
                game.setScreen(new MechanicsScreenThree(game));
            }
        });
    ...
    public MechanicsScreenTwo(BattleOfHogwarts g){
        super(g);
